...
class Gaussian:
    ...
    def calculate(self, G_type, symmetry_parameters, derivative):
        G, Gp = [], []
        Rc = 6.5
        functional = 'Cosine'
        Rs = 0.
            ...
            if derivative:
                for i in range(n_core):
                    for q in range(3):
                        gp = []
                        for ele in e_types:
                            gp.append(G1_prime(self.crystal,
                                               i=i,
                                               e_type=ele,
                                               ni=neighbors_info[i],
                                               functional=functional, Rc=Rc,
                                               p=i, q=q))
                        Gp.append(gp)
...
def G1(crystal, i, e_type, functional='Cosine', Rc=6.5):
    """
...
def G1_prime(crystal, i, e_type, ni, functional='Cosine', Rc=6.5, p=1, q=0):
    """
